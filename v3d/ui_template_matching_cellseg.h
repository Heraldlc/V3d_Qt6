...
public:
    ...
    {
        Dialog_TemplateMatchingSegPara->setWindowTitle(QApplication::translate("Dialog_TemplateMatchingSegPara", "Template matching segmentation parameters", 0));
        label->setText(QApplication::translate("Dialog_TemplateMatchingSegPara", "Channel", 0));
        label_3->setText(QApplication::translate("Dialog_TemplateMatchingSegPara", "Kernel (template)", 0));
        comboBox_Kernel->clear();
        comboBox_Kernel->insertItems(0, QStringList()
         << QApplication::translate("Dialog_TemplateMatchingSegPara", "Gaussian", 0)
        );
        label_5->setText(QApplication::translate("Dialog_TemplateMatchingSegPara", "Dimension \n"
"(radius, # pixels)", 0));
        label_2->setText(QApplication::translate("Dialog_TemplateMatchingSegPara", "x", 0));
        label_4->setText(QApplication::translate("Dialog_TemplateMatchingSegPara", "y", 0));
        label_7->setText(QApplication::translate("Dialog_TemplateMatchingSegPara", "z", 0));
        label_10->setText(QApplication::translate("Dialog_TemplateMatchingSegPara", "Standard Deviation", 0));
        label_6->setText(QApplication::translate("Dialog_TemplateMatchingSegPara", "x", 0));
        label_8->setText(QApplication::translate("Dialog_TemplateMatchingSegPara", "y", 0));
        label_9->setText(QApplication::translate("Dialog_TemplateMatchingSegPara", "z", 0));
        groupBox->setTitle(QApplication::translate("Dialog_TemplateMatchingSegPara", "Thresholds", 0));
        label_11->setText(QApplication::translate("Dialog_TemplateMatchingSegPara", "Pixel value >=", 0));
        label_12->setText(QApplication::translate("Dialog_TemplateMatchingSegPara", "Local region pixel \n"
"mean value >=", 0));
        label_13->setText(QApplication::translate("Dialog_TemplateMatchingSegPara", "Correlation >=", 0));
        groupBox_2->setTitle(QApplication::translate("Dialog_TemplateMatchingSegPara", "Other parameters", 0));
        label_14->setText(QApplication::translate("Dialog_TemplateMatchingSegPara", "region merge radius", 0));
        pushButton_cancel->setText(QApplication::translate("Dialog_TemplateMatchingSegPara", "Cancel", 0));
        pushButton_ok->setText(QApplication::translate("Dialog_TemplateMatchingSegPara", "OK", 0));
    } // retranslateUi
