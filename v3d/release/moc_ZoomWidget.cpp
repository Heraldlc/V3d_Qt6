...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_ZoomWidget_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_ZoomWidget_t qt_meta_stringdata_ZoomWidget = {
    {
QT_MOC_LITERAL(0, 10) // "ZoomWidget"
...
const QMetaObject ZoomWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZoomWidget.offsetsAndSize,
    qt_meta_data_ZoomWidget,
    qt_static_metacall,
    nullptr,
    nullptr,
    nullptr
...
void *ZoomWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Ui::ZoomWidget"))
        return static_cast< Ui::ZoomWidget*>(this);
