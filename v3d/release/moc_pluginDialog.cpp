...
#include <memory>
#include "../../plugin_loader/pluginDialog.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_PluginDialog_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_PluginDialog_t qt_meta_stringdata_PluginDialog = {
    {
QT_MOC_LITERAL(0, 12) // "PluginDialog"
...
const QMetaObject PluginDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_PluginDialog.offsetsAndSize,
