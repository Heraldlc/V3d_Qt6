...
struct qt_meta_stringdata_KeypointFeaturesDialog_t {
    const uint offsetsAndSize[8];
    char stringdata0[60];
};
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_KeypointFeaturesDialog_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_KeypointFeaturesDialog_t qt_meta_stringdata_KeypointFeaturesDialog = {
    {
QT_MOC_LITERAL(0, 22), // "KeypointFeaturesDialog"
QT_MOC_LITERAL(23, 16), // "compute_pointfea"
QT_MOC_LITERAL(40, 0), // ""
QT_MOC_LITERAL(41, 18) // "compute_similarmap"

    },
    "KeypointFeaturesDialog\0compute_pointfea\0"
    "\0compute_similarmap"
};
...
void KeypointFeaturesDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<KeypointFeaturesDialog *>(_o);
        (void)_t;
        switch (_id) {
...
const QMetaObject KeypointFeaturesDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_KeypointFeaturesDialog.offsetsAndSize,
    qt_meta_data_KeypointFeaturesDialog,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_KeypointFeaturesDialog_t
...
void *KeypointFeaturesDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_KeypointFeaturesDialog.stringdata0))
