...
struct qt_meta_stringdata_import_filelist_Dialog_t {
    const uint offsetsAndSize[8];
    char stringdata0[42];
};
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_import_filelist_Dialog_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_import_filelist_Dialog_t qt_meta_stringdata_import_filelist_Dialog = {
    {
QT_MOC_LITERAL(0, 22), // "import_filelist_Dialog"
QT_MOC_LITERAL(23, 15), // "updateFilterStr"
QT_MOC_LITERAL(39, 0), // ""
QT_MOC_LITERAL(40, 1) // "s"

    },
    "import_filelist_Dialog\0updateFilterStr\0"
    "\0s"
};
...
void import_filelist_Dialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<import_filelist_Dialog *>(_o);
        (void)_t;
        switch (_id) {
...
const QMetaObject import_filelist_Dialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_import_filelist_Dialog.offsetsAndSize,
    qt_meta_data_import_filelist_Dialog,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_import_filelist_Dialog_t
...
void *import_filelist_Dialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_import_filelist_Dialog.stringdata0))
        return static_cast<void*>(this);
    if (!strcmp(_clname, "Ui_import_filelist_tool"))
        return static_cast< Ui_import_filelist_tool*>(this);
