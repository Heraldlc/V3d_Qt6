...
struct qt_meta_stringdata_V3DGlobalPreferenceDialog_t {
    const uint offsetsAndSize[2];
    char stringdata0[26];
};
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_V3DGlobalPreferenceDialog_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_V3DGlobalPreferenceDialog_t qt_meta_stringdata_V3DGlobalPreferenceDialog = {
    {
QT_MOC_LITERAL(0, 25) // "V3DGlobalPreferenceDialog"

    },
    "V3DGlobalPreferenceDialog"
};
...
const QMetaObject V3DGlobalPreferenceDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_V3DGlobalPreferenceDialog.offsetsAndSize,
    qt_meta_data_V3DGlobalPreferenceDialog,
    qt_static_metacall,
    nullptr,
    nullptr,
    nullptr
...
void *V3DGlobalPreferenceDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_V3DGlobalPreferenceDialog.stringdata0))
        return static_cast<void*>(this);
    if (!strcmp(_clname, "Ui_Dialog_v3d_preference"))
        return static_cast< Ui_Dialog_v3d_preference*>(this);
