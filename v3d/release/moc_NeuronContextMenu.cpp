...
struct qt_meta_stringdata_NeuronContextMenu_t {
    const uint offsetsAndSize[2];
    char stringdata0[18];
};
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_NeuronContextMenu_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_NeuronContextMenu_t qt_meta_stringdata_NeuronContextMenu = {
    {
QT_MOC_LITERAL(0, 17) // "NeuronContextMenu"
...
const QMetaObject NeuronContextMenu::staticMetaObject = { {
    ...
    qt_meta_stringdata_NeuronContextMenu.offsetsAndSize,
    qt_meta_data_NeuronContextMenu,
    qt_static_metacall,
    nullptr,
    nullptr,
    nullptr
...
void *NeuronContextMenu::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_NeuronContextMenu.stringdata0))
