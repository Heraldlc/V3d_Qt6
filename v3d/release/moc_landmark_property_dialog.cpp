...
struct qt_meta_stringdata_LandmarkPropertyDialog_t {
    const uint offsetsAndSize[8];
    char stringdata0[43];
};
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_LandmarkPropertyDialog_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_LandmarkPropertyDialog_t qt_meta_stringdata_LandmarkPropertyDialog = {
    {
QT_MOC_LITERAL(0, 22), // "LandmarkPropertyDialog"
QT_MOC_LITERAL(23, 16), // "compute_rgn_stat"
QT_MOC_LITERAL(40, 0), // ""
QT_MOC_LITERAL(41, 1) // "c"

    },
    "LandmarkPropertyDialog\0compute_rgn_stat\0"
    "\0c"
};
...
void LandmarkPropertyDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<LandmarkPropertyDialog *>(_o);
        (void)_t;
        switch (_id) {
...
const QMetaObject LandmarkPropertyDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_LandmarkPropertyDialog.offsetsAndSize,
    qt_meta_data_LandmarkPropertyDialog,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_LandmarkPropertyDialog_t
...
void *LandmarkPropertyDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_LandmarkPropertyDialog.stringdata0))
